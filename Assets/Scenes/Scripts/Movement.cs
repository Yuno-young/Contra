...
public class Movement : MonoBehaviour 
{
    ...
    {
        if (collision.gameObject.CompareTag("Enemy")) // Khi va chạm với kẻ thù
        {
            FindObjectOfType<PlayerLive>().RemoveLife(); // Trừ mạng
        }
        if (collision.gameObject.CompareTag("Trap")) // Khi va chạm với kẻ thù
        {
            FindObjectOfType<PlayerLive>().RemoveLife(); // Trừ mạng
        }
